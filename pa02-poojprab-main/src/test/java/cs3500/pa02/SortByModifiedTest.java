...
import cs3500.pa02.SortByModified;
...
/**
 * From PA01:
 * test class to sort the testByModified class
 */
class SortByModifiedTest {

  SortByModified sbm = new SortByModified();
  ...
  /**
   * test method to test the compare method in terms of time modified
   */
  @Test
  public void testCompare() {
    assertEquals(-1, sbm.compare(mdfex1, mdfex2)); // Check results are as expected
    assertEquals(1, sbm.compare(mdfex2, mdfex1)); // Check results are as expected
    assertEquals(0, sbm.compare(mdfex2, mdfex3)); // Check results are as expected
  }
